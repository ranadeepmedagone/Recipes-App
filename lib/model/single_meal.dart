...
//
//     final MealSingle = MealSingleFromJson(jsonString);

import 'dart:convert';

MealSingle MealSingleFromJson(String str) =>
    MealSingle.fromJson(json.decode(str));

String MealSingleToJson(MealSingle data) => json.encode(data.toJson());
